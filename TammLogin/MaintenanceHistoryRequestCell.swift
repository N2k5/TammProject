//
//  MaintenanceHistoryRequestCell.swift
//  TammLogin
//
...
protocol MaintenanceHistoryRequestCellDelegate: AnyObject {
    func didTapView(request: MaintenanceRequest)
    func didTapCheckReview(request: MaintenanceRequest)
}

final class MaintenanceHistoryRequestCell: UITableViewCell {

    weak var delegate: MaintenanceHistoryRequestCellDelegate?
    ...
    private let reviewButton: UIButton = {
        ...
        b.setTitle("Check Review", for: .normal)
    ...
    private func setupUI() {
        ...
        NSLayoutConstraint.activate([
            ...
            reviewButton.topAnchor.constraint(equalTo: viewButton.bottomAnchor, constant: 8),
            reviewButton.leadingAnchor.constraint(equalTo: viewButton.leadingAnchor),
            reviewButton.trailingAnchor.constraint(equalTo: viewButton.trailingAnchor),
    ...
    @objc private func reviewTapped() {
        guard let request else { return }
        delegate?.didTapCheckReview(request: request)
    }
}
